            ...
            DTOAlumnoInscrito objAlumnoInscrito, DTOProspectoDetalle objProspectoDetalle)
        {
            ...
            using (UniversidadEntities db = new UniversidadEntities())
            {
                ...
                try
                {
                    ...
                    db.SaveChanges();
                    if (BLLOfertaEducativa.ConsultarOfertaEducativa(objAlumnoInscrito.OfertaEducativaId).Rvoe != null)
                    {
                        string MAtricula = Herramientas.Matricula.ObtenerMatricula(objAlumnoInscrito, BLLOfertaEducativa.ConsultarOfertaEducativa(objAlumnoInscrito.OfertaEducativaId), db.Alumno.Local[0].AlumnoId);
            ...
            using (UniversidadEntities db = new UniversidadEntities())
            {
                try
                {
                    ...
                    DTOAlumno objAlumno = new DTOAlumno
                    {
                        ...
                        lstOfertas = objAlB.AlumnoInscrito.Select(s =>
                    ...
                    List<DTOAlumnoOfertas> lstBitacora = db.AlumnoInscrito
        ...
        public static AlumnoPagos BuscarAlumno(int AlumnoId, int OfertaEducativaId)
        {
            using (UniversidadEntities db = new UniversidadEntities())
            {
                try
                {
                                            ...
                                            o.Cuota1.PagoConceptoId == 802).ToList().Count == 2)
                        {
                            ...
                            else
                            {
                                ...
                                objRegresa.Asesorias = lstPagos.Where(I => I.Cuota1.PagoConceptoId == 15)
                                                        .ToList().Count;
                                objRegresa.Grupo = db.AlumnoGrupoCuota.Where(
                                        k => k.AlumnoId == AlumnoId
                                            && k.OfertaEducativaId == OfertaEducativaId).ToList().Count > 0 ?
                                    db.Grupo.Where(gl => gl.GrupoId == db.AlumnoGrupoCuota.Where(
                                        k1 => k1.AlumnoId == AlumnoId
                            ...
                            else
                            {
                                ...
                                objRegresa = new AlumnoPagos
                                {
                                    ...
                                    Grupo = db.AlumnoGrupoCuota.Where(
                                        ...
                                        db.Grupo.Where(gl => gl.GrupoId == db.AlumnoGrupoCuota.Where(
                                            k1 => k1.AlumnoId == AlumnoId
                                                && k1.OfertaEducativaId == OfertaEducativaId)
                                                    .FirstOrDefault().GrupoId).DefaultIfEmpty(new Grupo { Descripcion = "" }).Single().Descripcion : ""
                                };
                            }
                        }
                        #endregion
                    ...
                    objRegresa.Revision = db.AlumnoRevision
                                            .Where(o =>
                                                o.AlumnoId == AlumnoId
                                                && o.OfertaEducativaId == OfertaEducativaId
                                                && o.Anio == objPeriodoActual.Anio
