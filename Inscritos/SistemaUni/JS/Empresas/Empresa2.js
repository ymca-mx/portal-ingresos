$(document).ready(function () {
    ...
    var Fila;
    var objEstados;
    var EmpresaI, GrupoI,OfertaI;
    var InscripcionID;
    var CuotaIdColegiatura;
    var MesP = [];
    var form = $('#formPopup');
...
function CargarOfertasL(OFertaEducativaId) {
    $("#slcOfertaEducativa").empty();
    var optionP = $(document.createElement('option'));
    optionP.text('--Seleccionar--');
    optionP.val('-1');
...
//_____________________________________________Antonio____________________________________________________________
var tblAlumnosCompletos1;
...
function CargarTablaAlumnosGrupo(GrupoId) {
    TM = 2;
    $.ajax({
        type: "POST",
        url: "../WebServices/WS/Empresa.asmx/ListarAlumnos",
