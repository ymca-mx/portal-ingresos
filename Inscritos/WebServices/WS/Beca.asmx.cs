...
namespace WebServices.WS
{
    ...
    public class Beca : System.Web.Services.WebService
    {
        ...
        {
            return BLL.BLLAlumno.BuscarAlumno(int.Parse(AlumnoId), int.Parse(OfertaEducativaId));
        }
        [WebMethod]
        ...
        public string InsertarVarios()
        {
            ...
            {
                AlumnoPagos objAl = BLL.BLLAlumno.BuscarAlumno(a.alumnoId);
                ...
                string Porcentaje, string UsuarioId)
        {
            ...
            try
            {
                BLL.BLLAlumno.AplicaBecaDeportiva(objBeca, false);
                return "Guardado";
            }
            catch { return "Fallo"; }
        }
        ...
        {
            return BLL.BLLOfertaEducativa.OfertaAlumno(int.Parse(AlumnoId));
        }
        [WebMethod]
