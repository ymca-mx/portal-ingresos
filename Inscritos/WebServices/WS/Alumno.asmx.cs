...
namespace WebServices.WS
{
    ...
    public class Alumno : System.Web.Services.WebService
    {
             ...
             string TelefonoCasaP, string TelefonoCasaP2, string EsEmpresa, string MedioDifusion, string Usuario)
        {
            ...
            try
            {
                ...
                new DTOPersonaAutorizada
             {
                ...
                string Alumnoid = BLLAlumno.InsertarAlumno(objAlumnoDetalle, objAlumno, lstPersona, objAlumnoIn, objProspectoDetalle);
        ...
        {
            return BLLAlumno.ListarAlumnos();
        }

        [WebMethod]
        public DTOAlumnoReferencias1 ConsultarAlumnoReferencias(int alumnoInt, int pagoid)
        {
            return BLLAlumno.ObtenerReferenciasAlumno(alumnoInt, pagoid);
        }

        [WebMethod]
        public List<DTOAlumno> ConsultarAlumnosBeca(string Ingles)
        {
            return BLLAlumno.ListarAlumnosBeca(Boolean.Parse(Ingles));
        }
        [WebMethod]
        ...
        {
            return BLLAlumno.ConsultarAlumnoPromocionCasa(int.Parse(AlumnoId), int.Parse(TA));
        }
        [WebMethod]
        public DTOAlumnoPromocionCasa PeriodosPromocionCasa(string AlumnoId, string TA)
        {
            return BLLAlumno.ConsultarAlumnoPromocionCasa(int.Parse(AlumnoId), int.Parse(TA));
        }
        [WebMethod]
        ...
        {
            return BLLAlumno.ObtenerAlumno1(int.Parse(AlumnoId));
        }
        [WebMethod]
        public DTOAlumnoPermitido1 ConsultarAlumno2(string AlumnoId)
        {
            return BLLAlumno.ObtenerAlumno2(int.Parse(AlumnoId));
        }
        [WebMethod]
        public List<DTOAlumno> BuscarAlumno(string Nombre, string Paterno, string Materno)
        {
            List<DTOAlumno> lstAlumno = BLLAlumno.ListarAlumnos(Nombre, Paterno, Materno);
        ...
        {
            return BLLAlumno.AlumnosEmpresa(int.Parse(grupoId));
        }
        [WebMethod]
        public List<DTOAlumno> ConsultarAlumnosDeEmpresa(string grupoId)
        {
            return BLLAlumno.AlumnosdeEmpresa(int.Parse(grupoId));
        }
        [WebMethod]
        public List<DTOPagos> ConsultarReferencias(string AlumnoId)
        {
            return BLLPago.ConsultarReferencias(int.Parse(AlumnoId));
        }
        [WebMethod]
        public List<DTOPagos> ConsultarReferencias2(string AlumnoId, string NoPagados)
        {
            return BLLPago.ConsultarReferencias(int.Parse(AlumnoId), Boolean.Parse(NoPagados));
        }
        [WebMethod]
        public List<DTOPagoParcial> ConsultarReferenciasPagadas(string AlumnoId)
        {
            return BLLPago.ConsultarReferenciasPagadas(int.Parse(AlumnoId));
        }
        [WebMethod]
        public List<DTOPagos> ConsultarReferenciasCP(string AlumnoId)
        {
            return BLLPago.ConsultarReferenciasConceptos(int.Parse(AlumnoId));
        }
        [WebMethod]
        public List<DTOPagos> ConsultarReferenciasCP2(string AlumnoId, string OfertaEducativaId)
        {
            return BLLPago.ConsultarReferenciasConceptos2(int.Parse(AlumnoId), int.Parse(OfertaEducativaId));
        }
        [WebMethod]
        public List<DTOPagos> ConsultarReferenciasCancelar(string AlumnoId)
        {
            return BLLPago.ConsultarReferenciasConceptosCancelar(int.Parse(AlumnoId));
        }
        [WebMethod]
        public List<ReferenciasPagadas> ConsultarReferenciasPagadasCortas(string AlumnoId)
        {
            return BLLPago.ReferenciasPagadasC(int.Parse(AlumnoId));
        }
        [WebMethod]
        public List<DTOAlumno> BuscarAlumnoFiltro(string filtro)
        {
            return BLLAlumno.BuscarAlumno(filtro);
        }
        [WebMethod]
        ...
        public doblesobj ConsultaPagosDetalle(string AlumnoId, string Anio, string PeriodoId)
        {
            ...
            try
            {
                List<DTOPagoDetallado> lstRes = BLLPago.ReferenciasPago(int.Parse(AlumnoId), int.Parse(Anio), int.Parse(PeriodoId));
                bool rest;
        ...
        {
            return BLLPeriodo.ConsultarPeriodos(int.Parse(AlumnoId));
        }
        [WebMethod]
        ...
        {
            return BLLAlumno.ObtenerAlumnoCompleto(int.Parse(AlumnoId));
        }
        ...
        {
            return BLLAlumno.ObenerDatosAlumnoActualiza(int.Parse(AlumnoId));
        }
        ...
        public bool UpdateAlumnoDatos(DTOAlumnoDetalle AlumnoDatos)
        {
            ...
            return BLLAlumno.UpdateAlumnoDatos(AlumnoDatos);
        }
            ...
            string Telefono2PA2, string Autoriza2)
        {
            ...
            return BLLAlumno.UpdateAlumno(objAlumnoUpdate, objProspectoDetalle, int.Parse(UsuarioId));
        }
        [WebMethod]
        ...
        {
            return BLLAlumno.ObtenerOfertasAlumno(int.Parse(AlumnoId));
        }
        [WebMethod]
        ...
        {
            return BLLPago.TraerAdeudos(int.Parse(AlumnoId), int.Parse(OfertaEducativaId));
        }
        [WebMethod]
