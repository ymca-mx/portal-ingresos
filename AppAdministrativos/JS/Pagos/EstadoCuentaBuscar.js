$(function () {
    ...
    var EdoCuntaFn = {
        ...
        BuscarAlumno(idAlumno) {
            $.ajax({
                ...
                success: function (data) {
                   ...
                   EdoCuntaFn.EstadoDeCuenta(data.d.AlumnoId,
                        Rango.substring(0, 10), Rango.substring(13, 23));
                }
            });
        },
        EstadoDeCuenta(Alumnoid, FechaI, FechaF) {
        ...
        CrearLista(datos) {
            ...
            EdoCuntaFn.CrearTabla(lstEstadoCuenta);
        },
        ...
        BuscarClick() {
            ...
            IndexFn.Block(true);
            EdoCuntaFn.BuscarAlumno(AlumnoId);
        }
    };
