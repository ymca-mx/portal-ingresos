$(document).ready(function () {
    ...
    var RptBecaFn = {
        init() {
            ...
            $('#btnBecas3').on('click', this.Becas3Click);
            this.CargarCuatrimestre();
        },
        BuscarClick() {
            ...
            RptBecaFn.CargarReporteBecas(anio, periodo);

        },
        Becas3Click(e) {
            e.preventDefault();
            RptBecaFn.exportarexcel();
        },
        CargarCuatrimestre() {
            $.ajax({
                type: 'POST',
        ...
        exportarexcel() {
            ...
            if ($("#tab_1").hasClass("active")) { $("#tab_2").addClass("active"); active1 = 1 }
            ...
            if (active1 == 1) { $("#tab_2").removeClass("active"); }
