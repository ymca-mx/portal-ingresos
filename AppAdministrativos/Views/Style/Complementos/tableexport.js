    ...
    if (typeof define === 'function' && define.amd) {
        ...
        var TableExport = function (selectors, options, isUpdate) {
            ...
            $("button[data-fileblob]")
                .off("click")
                .on("click", function () {
                    var object0 = $(this).data("fileblob");
                    var dataCabecero = object0.data[0];
                    for (var i=0; i< object0.data[0].length; i++)
                    {
                        dataCabecero[i] = dataCabecero[i].trim();
                    }
                    var objDatos = object0.data;

                    objDatos[0] = dataCabecero;
